...
def _main_result_rows() -> list[dict[str, Any]]:
    return [
        {"dataset": "fMoW", "run_id": "resnet50_13band", "model": "ResNet50", "axis": "geography", "protocol": "location_disjoint", "protocol_status": "formal_deployment", "aggregate_metric": "accuracy", "aggregate_value": 0.20002233638597275, "raw_bwer": 0.17361207464336303, "standardised_bwer": 0.14234836453364907},
        {"dataset": "fMoW", "run_id": "dofa_scaled10000", "model": "DOFA scaled", "axis": "geography", "protocol": "location_disjoint", "protocol_status": "formal_deployment", "aggregate_metric": "accuracy", "aggregate_value": 0.17768595041322313, "raw_bwer": 0.16141538857738702, "standardised_bwer": 0.1269780950367737},
        {"dataset": "reBEN", "run_id": "croma_s1", "model": "CROMA S1", "axis": "sensor/geography", "protocol": "multilabel_remote_sensing", "protocol_status": "formal_probability_aware", "aggregate_metric": "macro_ap", "aggregate_value": 0.4957580772190985, "raw_bwer": 0.1588281739799881, "standardised_bwer": 0.1588281739799881},
        {"dataset": "reBEN", "run_id": "croma_s2", "model": "CROMA S2", "axis": "sensor/geography", "protocol": "multilabel_remote_sensing", "protocol_status": "formal_probability_aware", "aggregate_metric": "macro_ap", "aggregate_value": 0.5817858667102239, "raw_bwer": 0.10553858910927061, "standardised_bwer": 0.10553858910927061},
        {"dataset": "reBEN", "run_id": "croma_s1_s2", "model": "CROMA S1+S2", "axis": "sensor/geography", "protocol": "multilabel_remote_sensing", "protocol_status": "formal_probability_aware", "aggregate_metric": "macro_ap", "aggregate_value": 0.6080083479682447, "raw_bwer": 0.07242186493060693, "standardised_bwer": 0.07242186493060693},
        {"dataset": "Sen1Floods11", "run_id": "prithvi_tl", "model": "Prithvi TL", "axis": "event", "protocol": "event_tail_segmentation", "protocol_status": "formal_segmentation", "aggregate_metric": "iou", "aggregate_value": 0.8051987522468903, "raw_bwer": 0.1175003367140734, "standardised_bwer": 0.15655975905862524},
        {"dataset": "Sen1Floods11", "run_id": "unet_vanilla", "model": "Vanilla U-Net", "axis": "event", "protocol": "event_tail_segmentation", "protocol_status": "formal_segmentation", "aggregate_metric": "iou", "aggregate_value": 0.751110769217214, "raw_bwer": 0.3188765524378785, "standardised_bwer": 0.2295156256914025},
        {"dataset": "Sen1Floods11", "run_id": "mndwi", "model": "MNDWI", "axis": "event", "protocol": "event_tail_segmentation", "protocol_status": "formal_segmentation", "aggregate_metric": "iou", "aggregate_value": 0.595166113508361, "raw_bwer": 0.15529557268478827, "standardised_bwer": 0.10040281744951218},
        {"dataset": "Sen1Floods11", "run_id": "s2_resnet34_unet", "model": "S2 ResNet34 U-Net", "axis": "event", "protocol": "event_tail_segmentation", "protocol_status": "formal_segmentation", "aggregate_metric": "iou", "aggregate_value": 0.7896841162497235, "raw_bwer": 0.17733362156729465, "standardised_bwer": 0.20953834627006696},
    ]
...
def _claim_support_table() -> list[dict[str, Any]]:
    return [
        ...
        {"claim_id": "C3", "claim": "ResNet50 is aggregate-best and DOFA is geography-BWER-best on formal fMoW location-disjoint outputs.", "claim_strength": "strong", "evidence_files": "drive_real_audit_v1; fmow_conformal_selective_audit_v1", "formal_status": "formal_location_disjoint", "primary_caveat": "DOFA result uses scaled preprocessing; debug/unscaled DOFA excluded."},
        ...
        {"claim_id": "C6", "claim": "CROMA S1+S2 improves reBEN aggregate and broad probability-aware BWER while residual tail risks remain.", "claim_strength": "moderate_strong", "evidence_files": "reBEN CROMA audit outputs", "formal_status": "formal_probability_aware", "primary_caveat": "Residual slice risks need interpretation by sensor/geography context."},
        {"claim_id": "C7", "claim": "Sen1Floods11 event-tail risk motivates deployment-slice audit for disaster segmentation.", "claim_strength": "moderate", "evidence_files": "Sen1 event-tail BWER outputs", "formal_status": "formal_segmentation_tail_risk", "primary_caveat": "Selective/conformal claims remain unavailable without probability maps."},
    ]
...
def _experiment_status_matrix() -> list[dict[str, Any]]:
    return [
        ...
        {"experiment": "AlphaEarth/GEE land-cover", "dataset": "planned", "status": "ready_to_design_not_run", "evidence_role": "next deployment axis", "allowed_claims": "None yet", "blocked_claims": "All empirical AlphaEarth claims until exports and BWER audit exist"},
    ]


def _metric_scope_matrix() -> list[dict[str, Any]]:
    return [
        {"metric": "Raw-BWER", "scope": "Slice worst-case excess risk over normalized audit tables", "formal_for": "fMoW, reBEN, Sen1", "caveat": "Requires adequate slice support and task-aware risk definitions."},
        {"metric": "Standardised-BWER", "scope": "Worst-case excess risk after balancing over available balance variable", "formal_for": "fMoW, reBEN, Sen1 where support allows", "caveat": "Missing balance policy and support thresholds remain part of the claim."},
...
def _selective_social_summary(selective_root: Path, social_root: Path) -> list[dict[str, Any]]:
    ...
    return [
        {"summary_item": "rank_divergence_under_selective_audit", "value": f"{n_div}/{n_total}", "interpretation": "ResNet50 remains aggregate-best while DOFA remains BWER-best across baseline, top-k, and calibrated-threshold settings."},
...
def _write_markdown(output: Path, random_social_rows: Sequence[Mapping[str, Any]] | None = None) -> dict[str, Path]:
    ...
    files["paper_ready_main_findings_v3"].write_text(
        ...
        "3. Under formal fMoW location-disjoint evaluation, ResNet50 is aggregate-best and DOFA scaled is geography-BWER-best; this divergence persists under confidence-conditioned audit.\n"
        ...
        "6. reBEN CROMA fusion improves aggregate and broad probability-aware BWER while leaving residual tail risks.\n"
        "7. Sen1Floods11 event-tail segmentation results motivate deployment-slice audit; conformal/selective segmentation remains unavailable without probability maps.\n",
        encoding="utf-8",
    )
    files["next_experiment_readiness_alphaearth_gee"].write_text(
        "# AlphaEarth/GEE land-cover readiness\n\n"
        "Do not run yet. Candidate datasets include Dynamic World, ESA WorldCover, national land-cover products where licensing is clean, and region-stratified held-out tiles exported from Google Earth Engine.\n\n"
...
def _write_figures(output: Path, main_rows: list[dict[str, Any]], protocol_rows: list[dict[str, Any]], social_rows: list[dict[str, str]]) -> dict[str, Path]:
    ...
    strength_map = {"strong": 3.0, "strong_protocol_contrast": 2.6, "strong_posthoc": 2.4, "moderate_strong": 2.2, "moderate": 1.8, "moderate_exploratory": 1.5}
