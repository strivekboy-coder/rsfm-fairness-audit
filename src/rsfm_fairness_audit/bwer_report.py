...
def write_bwer_report(
    ...
    lines = [
        ...
        f"- Task: `{task}`",
        "",
        "BWER measures excess risk in the worst tail of predefined slices relative to typical valid slices. It is evidence of slice-level deployment risk, not causal proof of model bias.",
        "",
        "## BWER Summary",
        "",
